          ...
          return (
            <div className="destination" >
              ...
              <div className="info">
                ...
                <button type="button" className="btn btn-warning" onClick={(e)=>handleEdit(e, p.pkgId)}>Edit</button>
                 <button type="button" className="btn btn-danger" onClick={(e)=>handleDelete(e, p.pkgId)}>Delete</button>
                </div>
                <h4>{p.ticketCost}</h4>
              </div>
